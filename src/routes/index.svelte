<script context="module">
  ...
  let social_urls = {
    github: "https://github.com/ashvala",
    twitter: "https://x.com/ashvala",
    instagram: "https://instagram.com/ashvalav",
    scholar:
      "https://scholar.google.com/citations?user=zsDPEzgAAAAJ&hl=en&oi=ao",
    linkedin: "https://www.linkedin.com/in/ashvalavinay/",
  };
</script>
...
<Container>
  ...
  <Row xs>
    <Col>
      <Image thumbnail src="{base}/me.jpg" alt="Ashvala" class="me_img" />
    </Col>
    <Col>
      <div class="content">
        <h1>Hi, I am Ashvala Vinay!</h1>
        <p>I am a co-founder of <a href="https://nonety.pe"> NoneType! </a></p>
        <p>
          Previously, I was a PhD student at Georgia Tech's Center for Music
          Technology. I worked with Prof. Alexander Lerch on problems related to
          evaluating generative audio synthesizers.
        </p>
        <p>
          I graduated from Berklee College of Music in 2016. Following that, I
...
<style>
  :global(body) {
    font-family: "Merriweather", "Avenir";
  }
